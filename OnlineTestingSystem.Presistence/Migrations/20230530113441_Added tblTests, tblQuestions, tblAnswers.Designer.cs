...
namespace OnlineTestingSystem.Presistence.Migrations
{
    ...
    [Migration("20230530113441_Added tblTests, tblQuestions, tblAnswers")]
    partial class AddedtblTeststblQuestionstblAnswers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineTestingSystem.Domain.AnswerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OnlineTestingSystem.Domain.QuestionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OnlineTestingSystem.Domain.TestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OnlineTestingSystem.Domain.AnswerEntity", b =>
                {
                    b.HasOne("OnlineTestingSystem.Domain.QuestionEntity", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("OnlineTestingSystem.Domain.QuestionEntity", b =>
                {
                    b.HasOne("OnlineTestingSystem.Domain.TestEntity", "Test")
                        .WithMany("Questions")
